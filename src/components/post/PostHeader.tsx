...
import PostActions from "./PostActions"; // Asegúrate de que esto importa PostActions
...
export default function PostCard({ post, onLike, onSave, onReport }: PostCardProps) {
    ...
    // ✅ PROTECCIÓN: Si no hay post o autor, no renderizamos nada para evitar errores
    if (!post || !post.author) {
        return null; 
    }
    ...
    return (
        <div className="card bg-base-100 shadow-sm">
            <div className="card-body p-4">
                ...
                {/* ✅ AQUI ESTABA EL ERROR: Debe ser PostActions, NO PostCard */}
                <PostActions 
                    isLiked={isLiked}
                    isSaved={isSaved}
                    likes={likes}
